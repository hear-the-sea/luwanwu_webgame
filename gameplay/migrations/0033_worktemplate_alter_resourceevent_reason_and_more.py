        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "tier",
                    models.CharField(
                        choices=[("junior", "初级工作区"), ("intermediate", "中级工作区"), ("senior", "高级工作区")],
                        default="junior",
                        max_length=16,
                        verbose_name="工作区等级",
                    ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "status",
                    models.CharField(
                        choices=[("working", "打工中"), ("completed", "已完成"), ("recalled", "已召回")],
                        default="working",
                        max_length=16,
                        verbose_name="状态",
                    ),
            ...
            options={
                ...
                "ordering": ["-started_at"],
                "indexes": [
                    models.Index(fields=["status", "-started_at"], name="gameplay_wo_status_f59fc1_idx"),
                    models.Index(fields=["guest", "-started_at"], name="gameplay_wo_guest_i_ce4e7e_idx"),
                ],
            },
        ),
    ]
