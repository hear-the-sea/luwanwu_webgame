...
def test_start_raid_concurrent_requests_respect_limit_inside_lock(monkeypatch, django_user_model):
    ...
    attacker, defender = build_attacker_defender(
        django_user_model,
        attacker_username="raid_concurrent_attacker",
        defender_username="raid_concurrent_defender",
    )
...
def test_request_raid_retreat_concurrent_requests_allow_only_one_transition(monkeypatch, django_user_model):
    ...
    attacker, defender = build_attacker_defender(
        django_user_model,
        attacker_username="raid_retreat_concurrent_attacker",
        defender_username="raid_retreat_concurrent_defender",
    )
