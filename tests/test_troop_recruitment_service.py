...
from core.exceptions import MessageError, TroopRecruitmentAlreadyInProgressError, TroopRecruitmentError
...
def test_schedule_recruitment_completion_missing_target_module_degrades(monkeypatch):
    ...
    recruitment = type("_Recruitment", (), {"id": 19, "manor_id": 5, "troop_key": "scout"})()
